...
<svelte:head>
  <title>Local auth mailbox · Nettiva</title>
...
<div class="shell">
  ...
  <main>
    <div class="intro">
      ...
      <div><span class="kicker">AUTH OUTBOX</span><h1>Nettiva mailbox</h1><p>Verification and recovery links are captured here locally so we can test the entire account lifecycle without sending real email.</p></div>
    </div>
...
<style>
  ...
  .icon { width: 42px; height: 42px; display: grid; place-items: center; flex: 0 0 auto; border-radius: 10px; color: #b8f34a; background: #1a2814; }
  ...
  .mail-meta span { color: #b8f34a; font: 800 .62rem Consolas, monospace; text-transform: uppercase; letter-spacing: .08em; }
